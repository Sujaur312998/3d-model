...
// Color configuration for the 5 balls
const ballColors = [
  "#FF6B6B", // Red
  "#FFFF00", // Teal
  "#800080", // Blue
  ...
  useEffect(() => {
    ...
    scene.traverse((child) => {
      ...
      if (
        ...
        // Apply color to ball material
        const ballIndex = ballsRef.current.length - 1;
        if (ballIndex < ballColors.length) {
          const color = ballColors[ballIndex];
          ...
          ballMaterialsRef.current.push(newMaterial);
        }
      }
...
// } from "@react-three/drei";
// import * as THREE from "three";
// import { Palette, Code, Megaphone, Globe, Brain } from "lucide-react";

// // Ball configuration with colors and icons
// const ballConfigs = [
//   { color: "#FF6B6B", icon: Palette, label: "Branding" },
//   { color: "#4ECDC4", icon: Megaphone, label: "Marketing" },
//   { color: "#45B7D1", icon: Globe, label: "Web Dev" },
//   { color: "#FFA07A", icon: Code, label: "App Dev" },
//   { color: "#98D8C8", icon: Brain, label: "AI" },
// ];

// function BallWithIcon({ ball, config, index }) {
...
//         // Apply color to ball material
//         const ballIndex = ballsRef.current.length - 1;
//         if (ballIndex < ballConfigs.length) {
...
//     if (!p.isDragging) {
//       p.targetScroll = THREE.MathUtils.lerp(p.targetScroll, 0, 0.08);
//       p.handOffset = THREE.MathUtils.lerp(p.handOffset, 0, 0.08);
//     }
...
//           Drag to interact with the model
//         </div>
//       </div>
